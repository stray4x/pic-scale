...
export const envValidationSchema = Joi.object({
  ...
  [env.MINIO_ENDPOINT]: Joi.string(),
  [env.MINIO_PORT]: Joi.number().port(),
  [env.MINIO_USE_SSL]: Joi.boolean(),
  [env.MINIO_ACCESS_KEY]: Joi.string(),
  [env.MINIO_SECRET_KEY]: Joi.string(),
  [env.MINIO_BUCKET]: Joi.string(),
